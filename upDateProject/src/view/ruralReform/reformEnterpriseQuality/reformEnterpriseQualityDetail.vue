                ...
                <el-collapse-item name="1">
                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            ...
                            <el-form-item label="行业名称" prop="industry" class="formItem formSelect">
                                <el-select v-model="ruleForm.industry" filterable clearable :disabled="urlType" placeholder="请选择行业名称">
                                    <el-option
                            ...
                            <el-form-item label="产品名称" prop="productName" class="formItem">
                                <el-input v-model="ruleForm.productName" :disabled="urlType" placeholder="请输入产品名称"></el-input>
                            </el-form-item>

                            <el-form-item label="产品类型" prop="productType" class="formItem formSelect">
                                <el-select v-model="ruleForm.productType" filterable clearable :disabled="urlType" placeholder="请选择产品类型">
                                    <el-option
                            ...
                            <el-form-item label="单位性质" prop="enterpriseType" class="formItem formSelect">
                                <el-select v-model="ruleForm.enterpriseType" filterable clearable :disabled="urlType" placeholder="请选择单位性质">
                                    <el-option
                            ...
                            <el-form-item label="证书有效期" class="formItem">
                                <el-date-picker
                                    :disabled="urlType"
                                    type="daterange"
                                    range-separator="至"
                            ...
                            <el-form-item label="证书编号" class="formItem">
                                <el-input v-model="ruleForm.companyType" :disabled="urlType" placeholder="请输入证书编号"></el-input>
                            </el-form-item>

                            <div style="clear:both;"></div>

                            <el-form-item label="姓名" prop="contact" class="formItem">
                                <el-input v-model="ruleForm.contact" :disabled="urlType" placeholder="请输入姓名"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="种植面积" prop="scale" class="formItem">
                                <el-input v-model="ruleForm.scale" :disabled="urlType" placeholder="请输入种植面积"></el-input>（亩）
                            </el-form-item>

                            <el-form-item label="产量" prop="yield" class="formItem">
                                <el-input v-model="ruleForm.yield" :disabled="urlType" placeholder="请输入产量"></el-input>（吨）
                            </el-form-item>

                            <el-form-item label="申请人地址" prop="address" class="formItem_line">
                                <el-input v-model="ruleForm.address" :disabled="urlType" placeholder="请输入申请人地址"></el-input>
                            </el-form-item>
...
import { threePoneBInsert,threePoneBDetail,threePoneBUpdate } from '@/utils/api/threePoneB/threePoneB' //产业办---三品一标数据
import {townshipOption,subjectTypeOption,enterpriseTypeOption,enterpriseKindOption,productType,subjectTypAeOption} from "@/assets/js/commonOptions";
...
export default {
    ...
    data() {
        return {
            ...
            subjectTypAeOption:subjectTypAeOption,  //单位性质
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            console.log(this.id)
            let res = await threePoneBDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await threePoneBUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await threePoneBInsert(addObj);
            console.log(res)
             if(res.data.status== 0){
                this.$message({
                    message:'新增成功',
