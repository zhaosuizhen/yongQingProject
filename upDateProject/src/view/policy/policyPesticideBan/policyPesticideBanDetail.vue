                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            ...
                            <el-form-item label="农药名称" prop="pesticideName" >
                                <el-input  :disabled="urlType" v-model="ruleForm.pesticideName" placeholder="请输入农药名称"></el-input>
                            </el-form-item>

                            <el-form-item label="限用原因" prop="limitReason" >
                                <el-input  :disabled="urlType" v-model="ruleForm.limitReason" placeholder="请输入限用名称"></el-input>
                            </el-form-item>

                            <el-form-item label="禁用范围" prop="banScope" >
                                <el-input  :disabled="urlType" v-model="ruleForm.banScope" placeholder="请输入禁用范围"></el-input>
                            </el-form-item>

                            <el-form-item label="文件名称" prop="fileName" >
                                <el-input  :disabled="urlType" v-model="ruleForm.fileName" placeholder="请输入文件名称"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="禁用日期" prop="banTime" >
                                <el-date-picker
                                    v-model="ruleForm.banTime"
                                    :disabled="urlType"
                                    type="date"
                                    placeholder="选择日期">
                                </el-date-picker>
...
import { noPesticidesInsert,noPesticidesDetail,noPesticidesUpdate } from '@/utils/api/policy/policyPesticideBan' //政策法规---禁用农药
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                limitReason:[
                      {required: true, message: '请输入限用原因',trigger: 'blur', }
                ],
                banScope:[
                      {required: true, message: '请输入禁用范围',trigger: 'blur', }
                ],
                fileName:[
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            console.log(this.id)
            let res = await noPesticidesDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await noPesticidesUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await noPesticidesInsert(addObj);
            console.log(res)
             if(res.data.status== 0){
                this.$message({
                    message:'新增成功',
