<template>
  <!--产业办—— 绿色食品企业产品数据 详情-->
    <div id="doGreenFoodValueDetail" class="pageContent" v-loading="loading">
                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            ...
                            <el-form-item label="核准产量：" prop="approvedProduction" class="formItem">
                                <el-input v-model="ruleForm.approvedProduction" :disabled="urlType" placeholder="请输入核准产量"></el-input>（吨）
                            </el-form-item>
...
<script>
//质检办--绿色食品企业产品数据和产业办--绿色食品企业产品数据使用同一个接口
import { qualityGreenFoodDetail, qualityGreenFoodUpdate, qualityGreenFoodInsert } from '@/utils/api/qualityInspection/qualityGreenfoodEnterprises'; 
