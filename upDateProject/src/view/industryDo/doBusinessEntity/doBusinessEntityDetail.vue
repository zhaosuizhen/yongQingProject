                ...
                <el-collapse-item name="1">
                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            <el-form-item label="经营主体名称：" prop="enterpriseName" class="formItem autocomplete">
                                <el-autocomplete
                                    :disabled="urlType"
                            ...
                            <el-form-item label="单位性质：" prop="subjectType" class="formItem formSelect">
                                <el-select v-model="ruleForm.subjectType" filterable clearable :disabled="urlType" placeholder="请选择单位性质">
                                    <el-option
                            ...
                            <el-form-item label="注册资本：" prop="registeredCapital" class="formItem">
                                <el-input v-model="ruleForm.registeredCapital" :disabled="urlType" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');" placeholder="请输入注册资本"></el-input> (万元)
                            </el-form-item>
                            <div style="clear:both;"></div>
                            <el-form-item label="经营性质" prop="manageType" class="formItem formSelect">
                                <el-select v-model="ruleForm.manageType" filterable clearable :disabled="urlType" placeholder="请选择主体类型">
                                    <el-option
...
<script>
import { doBusinessEntityDetail,doBusinessEntityUpdate, doBusinessEntityInsert,getEnterpriseNameList } from '@/utils/api/industryDo/doBusinessEntity' //产业办---经营主体数据
