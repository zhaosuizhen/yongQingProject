                    ...
                    <el-collapse-item name="1">
                        ...
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="年份：" prop="dataYear" class="formItem">
                                    <el-date-picker
...
<script>
//种植业股---农林牧渔增加值 接口
import { ZJZ_NLMYDetail,ZJZ_NLMYUpdate, ZJZ_NLMYInsert } from '@/utils/api/planting/ZJZ_NLMY' 
...
export default {
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            let res = await ZJZ_NLMYDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await ZJZ_NLMYUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await ZJZ_NLMYInsert(addObj);
             if(res.data.status== 0){
                this.$message({
                    message: '新增成功',
                    type: 'success'
