                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                           <el-form-item label="年份" prop="years" class="formItem formSelect">
                            ...
                            <el-form-item label="产品图片"  class="formItem">
                            ...
                            <el-form-item label="产品简介" prop="introduction" class="formItem-textarea">
                                <el-input v-model="ruleForm.introduction" type="textarea" :rows="5" :disabled="urlType" class="formTextarea" placeholder="请输入产品简介"></el-input>
                            </el-form-item>
...
import { maiDongProductsUpdate, maiDongProductsInsert,maiDongProductsDetail,uploadImg } from '@/utils/api/cashCropStation/maiDongProducts' //经作站---麦冬加工品
...
export default {
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            let res = await maiDongProductsDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await maiDongProductsUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await maiDongProductsInsert(addObj);
             if(res.data.status== 0){
                this.$message({
                    message:'新增成功',
                    type: 'success'
