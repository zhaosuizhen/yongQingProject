                ...
                <el-collapse-item name="1">
                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            <el-form-item label="基地名称"  prop="baseName" class="formItem">
                                <el-input v-model="ruleForm.baseName" :disabled="urlType" placeholder="请输入基地名称"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="联系人"  prop="legalPerson" class="formItem">
                                <el-input v-model="ruleForm.legalPerson" :disabled="urlType" placeholder="请输入联系人"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="种植面积" class="formItem">
                                <el-input v-model="ruleForm.plantArea" :disabled="urlType" placeholder="请输入种植面积"></el-input>（亩）
                            </el-form-item>
                            <div style="clear:both;"></div>
                            
                            <el-form-item label="种植品种" class="formItem-textarea">
                                <el-input v-model="ruleForm.plantType" type="textarea" :rows="5" :disabled="urlType" class="formTextarea" placeholder="请输入种植品种"></el-input>
                            </el-form-item>
...
import { fruitAndVegetableUpdate, fruitAndVegetableInsert,fruitAndVegetableDetail } from '@/utils/api/cashCropStation/fruitAndVegetable' //经作站---乡镇果蔬标准化基地
...
export default {
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            let res = await fruitAndVegetableDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await fruitAndVegetableUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await fruitAndVegetableInsert(addObj);
             if(res.data.status== 0){
                this.$message({
                    message:'新增成功',
                    type: 'success'
