                ...
                <el-collapse-item name="1">
                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            <el-form-item label="企业名称"  prop="enterpriseName" class="formItem">
                                <el-input v-model="ruleForm.enterpriseName" :disabled="urlType" placeholder="请输入企业名称"></el-input>
                            </el-form-item>
                            <el-form-item label="企业类型" class="formItem">
                                <el-input v-model="ruleForm.enterpriseType" :disabled="urlType" placeholder="请输入企业类型"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="联系人" class="formItem">
                                <el-input v-model="ruleForm.concact" :disabled="urlType" placeholder="请输入联系人"></el-input>
                            </el-form-item>
                            <el-form-item label="联系电话" class="formItem">
                                <el-input v-model="ruleForm.phone" :disabled="urlType" placeholder="请输入联系电话"></el-input>
                            </el-form-item>
                            <div style="clear:both;"></div>
                            <el-form-item label="邮编" class="formItem">
                                <el-input v-model="ruleForm.postalCode" :disabled="urlType" placeholder="请输入邮编"></el-input>
                            </el-form-item>
                            <el-form-item label="邮寄地址" class="formItem">
                                <el-input v-model="ruleForm.mailAddress" :disabled="urlType" placeholder="请输入邮寄地址"></el-input>
                            </el-form-item>
                            <div style="clear:both;"></div>
                            <el-form-item label="注册日期" class="formItem">
                                <el-date-picker
...
import { veterinaryMedicineEnterpriseUpdate, veterinaryMedicineEnterpriseInsert,veterinaryMedicineEnterpriseDetail } from '@/utils/api/veterinaryMedicine/veterinaryMedicineEnterprise' //兽医兽药股---兽医站
...
export default {
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            let res = await veterinaryMedicineEnterpriseDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await veterinaryMedicineEnterpriseUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await veterinaryMedicineEnterpriseInsert(addObj);
             if(res.data.status== 0){
                this.$message({
                    message:'新增成功',
                    type: 'success'
