                ...
                <el-collapse-item name="1">
                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            <el-form-item label="机构名称"  prop="hospitalName" class="formItem">
                                <el-input v-model="ruleForm.hospitalName" :disabled="urlType" placeholder="请输入机构名称"></el-input>
                            </el-form-item>
                            ...
                            <div style="clear:both;"></div>
                            <el-form-item label="注册资金" class="formItem">
...
import { veterinaryHospitalUpdate, veterinaryHospitalInsert,veterinaryHospitalDetail } from '@/utils/api/veterinaryMedicine/veterinaryHospital' //兽医兽药股---兽医站
...
export default {
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            let res = await veterinaryHospitalDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await veterinaryHospitalUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await veterinaryHospitalInsert(addObj);
             if(res.data.status== 0){
                this.$message({
                    message:'新增成功',
                    type: 'success'
