<template>
    <!--质检办---无公害企业产品数据详情-->
    <div class="qualityPollutionProductsDetail pageContent" v-loading="loading">
                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
                            <el-form-item label="产品：" prop="productName" class="formItem">
                                <el-input v-model="ruleForm.productName" :disabled="urlType" placeholder="请输入产地监测面积"></el-input>（亩）
                            </el-form-item>
                            <el-form-item label="规模：" prop="scale" class="formItem">
                                <el-input v-model="ruleForm.scale" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');" :disabled="urlType" placeholder="请输入规模"></el-input>（吨）
                            </el-form-item>
                            <div style="clear:both;"></div>
...
import { qualityPollutionDetail, qualityPollutionUpdate, qualityPollutionInsert } from '@/utils/api/qualityInspection/qualityPollutionProducts'; //质检办--无公害企业产品数据
