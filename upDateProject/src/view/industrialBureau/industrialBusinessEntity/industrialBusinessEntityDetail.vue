<template>
<!--工商局---经营主体数据详情-->
    <div id="industrialBusinessEntityDetail" class="pageContent" v-loading="loading">
                ...
                <el-collapse-item name="1">
                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            <el-form-item label="公司名称" prop="enterpriseName" class="formItem autocomplete">
                                <el-autocomplete
...
<script>
//工商局经营主体与 产业办---经营主体数据使用相同接口
import { doBusinessEntityDetail,doBusinessEntityUpdate, doBusinessEntityInsert,getEnterpriseNameList } from '@/utils/api/industryDo/doBusinessEntity';
...
export default {
    name:'industrialBusinessEntityDetail',
    data() {
        return {
