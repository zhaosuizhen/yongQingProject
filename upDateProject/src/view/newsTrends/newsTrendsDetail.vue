<template>
  <!--新闻动态  新增 查看 编辑-->
    <div id="newsTrendsDetail" class="pageContent" v-loading="loading">
                    ...
                    <div class="formContent">
                        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            <el-form-item label="新闻标题：" prop="title">
                                <el-input v-model="ruleForm.title" :disabled="urlType" placeholder="请输入新闻标题"></el-input>
                            </el-form-item>
                            <el-form-item label="类型：" prop="newType">
                                <el-input v-model="ruleForm.newType" :disabled="urlType" placeholder="请输入类型"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="新闻内容：" prop="content">
                                <el-input v-model="ruleForm.content" type="textarea" :rows="4" :disabled="urlType" placeholder="请输入新闻内容"></el-input>
                            </el-form-item>
                        </el-form>
...
<script>
import { newsTrendsDetail,newsTrendsUpdate, newsTrendsInsert } from '@/utils/api/newsTrends/newsTrends' //新闻动态
import {townshipOption} from "@/assets/js/commonOptions";
import {handleCofirm} from '@/utils/messageBox/confirm';
import {getData} from '@/utils/nowTime';
import CustomForm from '@/components/customForm/CustomForm';
export default {
    name:'newsTrendsDetail',
    data() {
        return {
            ...
            rules: {
                ...
                newType: [
                    { required: true, message: '请填写新闻类型',trigger: 'blur' }
                ],
                introduce: [
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            let res = await newsTrendsDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await newsTrendsUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await newsTrendsInsert(addObj);
             if(res.data.status== 0){
                this.$message({
                    message: '新增成功',
                    type: 'success'
