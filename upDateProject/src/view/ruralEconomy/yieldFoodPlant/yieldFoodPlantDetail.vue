                        ...
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="大麦" class="formItem">
                                    <el-input v-model="ruleForm.grainBarley" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入大麦数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="高粱" class="formItem">
                                    <el-input v-model="ruleForm.grainBroomcorn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入高粱数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="荞麦" class="formItem">
                                    <el-input v-model="ruleForm.grainBuckwheat" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入荞麦数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="玉米" class="formItem">
                                    <el-input v-model="ruleForm.grainCorn" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入玉米数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="谷子" class="formItem">
                                    <el-input v-model="ruleForm.grainMillet" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入谷子数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="燕麦" class="formItem">
                                    <el-input v-model="ruleForm.grainOat" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入燕麦数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="稻谷" class="formItem">
                                    <el-input v-model="ruleForm.grainRice" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入稻谷数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="春小麦" class="formItem">
                                    <el-input v-model="ruleForm.grainWheatSpring" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入春小麦数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="冬小麦" class="formItem">
                                    <el-input v-model="ruleForm.grainWheatWinter" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入冬小麦数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="其他" class="formItem">
                                    <el-input v-model="ruleForm.grainOther" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入其他谷物数量"></el-input> （吨）
                                </el-form-item>
                    ...
                    <el-collapse-item name="2">
                        <template slot="title">
                            <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('2') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                <span>豆类</span>
                                <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.douLeiData}}</span> 吨</span>
                            </div>
                        </template>
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                <el-form-item label="红小豆" class="formItem">
                                    <el-input v-model="ruleForm.beanAzuki" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入红小豆数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="绿豆" class="formItem">
                                    <el-input v-model="ruleForm.beanMung" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入绿豆数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="大豆" class="formItem">
                                    <el-input v-model="ruleForm.beanSoya" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入大豆数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="其他" class="formItem">
                                    <el-input v-model="ruleForm.beanOther" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入其他豆类数量"></el-input> （吨）
                                </el-form-item>
                            </el-form>
                            <el-collapse v-model="activeNames" @change="handleChange">
                        ...
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                <el-form-item label="洋芋" class="formItem">
                                    <el-input v-model="ruleForm.tuberPotato" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入洋芋数量"></el-input> （吨）
                                </el-form-item>
                                <el-form-item label="红苕" class="formItem">
                                    <el-input v-model="ruleForm.tuberYam" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入红苕数量"></el-input> （吨）
                                </el-form-item>
                            </el-form>
                        </div>
                    </el-collapse-item>
...
<script>
//统计局---畜产品产量 接口
import { foodPlantYieldDetail,foodPlantYieldUpdate, foodPlantYieldInsert } from '@/utils/api/ruralEconomy/foodPlantYield' 
...
export default {
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            let res = await foodPlantYieldDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await foodPlantYieldUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await foodPlantYieldInsert(addObj);
             if(res.data.status== 0){
                this.$message({
                    message: '新增成功',
                    type: 'success'
