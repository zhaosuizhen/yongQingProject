                    ...
                    <el-collapse-item name="1">
                        <template slot="title">
                            <div  class="titleContent">
                                ...
                                <span>油料播种面积</span>
                                <span class="titleRight">总计：<span class="valueStyle">{{ruleForm.YLBZMJData}}</span> 亩/公斤</span>
                            </div> 
                        </template>
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="花生" class="formItem">
                                    <el-input v-model="ruleForm.oilPeanut" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入花生数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="油菜籽" class="formItem">
                                    <el-input v-model="ruleForm.oilRapeseed" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入油菜籽数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="芝麻" class="formItem">
                                    <el-input v-model="ruleForm.oilSesame" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入芝麻数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="胡芝麻" class="formItem">
                                    <el-input v-model="ruleForm.oilSesameHu" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入胡芝麻数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="葵花籽" class="formItem">
                                    <el-input v-model="ruleForm.oilSunflower" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入葵花籽数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="其他油料" class="formItem">
                                    <el-input v-model="ruleForm.oilOther" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入其他油料数量"></el-input> （亩/公斤）
                                </el-form-item>
                    ...
                    <el-collapse-item name="2">
                        <template slot="title">
                            <div  class="titleContent">
                                ...
                                <span>棉花播种面积</span>
                                <span class="titleRight">总计：<span class="valueStyle">{{ruleForm.MHBZMJData}}</span> 亩/公斤</span>
                            </div> 
                        </template>
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="棉花" class="formItem">
                                    <el-input v-model="ruleForm.cotton" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入棉花数量"></el-input> （亩/公斤）
                                </el-form-item>
                    ...
                    <el-collapse-item name="3">
                        <template slot="title">
                            <div  class="titleContent">
                                ...
                                <span>生麻播种面积</span>
                                <span class="titleRight">总计：<span class="valueStyle">{{ruleForm.SMBZMJData}}</span> 亩/公斤</span>
                            </div> 
                        </template>
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="生黄红麻" class="formItem">
                                    <el-input v-model="ruleForm.linenJute" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入生黄红麻数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="生大麻" class="formItem">
                                    <el-input v-model="ruleForm.linenHemp" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入生大麻数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="生苎麻" class="formItem">
                                    <el-input v-model="ruleForm.linenRamee" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入生苎麻数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="生亚麻" class="formItem">
                                    <el-input v-model="ruleForm.linenFlax" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入生亚麻数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="其他" class="formItem">
                                    <el-input v-model="ruleForm.linenOther" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入其他数量"></el-input> （亩/公斤）
                                </el-form-item>
                    ...
                    <el-collapse-item name="4">
                        <template slot="title">
                            <div  class="titleContent">
                                ...
                                <span>糖料播种面积</span>
                                <span class="titleRight">总计：<span class="valueStyle">{{ruleForm.TLBZMJData}}</span> 亩/公斤</span>
                            </div> 
                        </template>
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="甘蔗" class="formItem">
                                    <el-input v-model="ruleForm.sugarCane" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入甘蔗数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="甜菜" class="formItem">
                                    <el-input v-model="ruleForm.sugarBeet" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入甜菜数量"></el-input> （亩/公斤）
                                </el-form-item>
                    ...
                    <el-collapse-item name="5">
                        <template slot="title">
                            <div  class="titleContent">
                                ...
                                <span>烟叶</span>
                                <span class="titleRight">总计：<span class="valueStyle">{{ruleForm.YYData}}</span> 亩/公斤</span>
                            </div> 
                        </template>
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="烤烟" class="formItem">
                                    <el-input v-model="ruleForm.tobacco" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入烤烟数量"></el-input> （亩/公斤）
                                </el-form-item>
                    ...
                    <el-collapse-item name="6">
                        <template slot="title">
                            <div  class="titleContent">
                                ...
                                <span>中草药材</span>
                                <span class="titleRight">总计：<span class="valueStyle">{{ruleForm.ZCYCData}}</span> 亩/公斤</span>
                            </div> 
                        </template>
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="人参" class="formItem">
                                    <el-input v-model="ruleForm.tcmGinseng" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入人参数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="枸杞" class="formItem">
                                    <el-input v-model="ruleForm.tcmLycium" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入枸杞数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="甘草" class="formItem">
                                    <el-input v-model="ruleForm.tcmLiquorice" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入甘草数量"></el-input> （亩/公斤）
                                </el-form-item>
                    ...
                    <el-collapse-item name="7">
                        <template slot="title">
                            <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                <span>蔬菜及食用菌</span>
                                <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.SCJSYJData}}</span> 亩/公斤</span>
                            </div>
                        </template>
                        <div class="formContent">
                                ...
                                <el-collapse-item name="7-1">
                                    <template slot="title">
                                        <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7-1') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                            <span>叶菜类</span>
                                            <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.YCLData}}</span> 亩/公斤</span>
                                        </div>
                                    </template>
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="芹菜" class="formItem">
                                                <el-input v-model="ruleForm.veggieCelery" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入芹菜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="菠菜" class="formItem">
                                                <el-input v-model="ruleForm.veggieSpinach" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入菠菜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="油菜" class="formItem">
                                                <el-input v-model="ruleForm.veggieRape" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入油菜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
                                ...
                                <el-collapse-item name="7-2">
                                    <template slot="title">
                                        <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7-2') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                            <span>白菜类</span>
                                            <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.BCLData}}</span> 亩/公斤</span>
                                        </div>
                                    </template>
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="大白菜" class="formItem">
                                                <el-input v-model="ruleForm.veggieCabbage" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入大白菜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
                                ...
                                <el-collapse-item name="7-3">
                                    <template slot="title">
                                        <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7-3') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                            <span>甘蓝类</span>
                                            <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.GLLData}}</span> 亩/公斤</span>
                                        </div>
                                    </template>
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="卷心菜" class="formItem">
                                                <el-input v-model="ruleForm.veggieRepollo" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入卷心菜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
                                ...
                                <el-collapse-item name="7-4">
                                    <template slot="title">
                                        <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7-4') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                            <span>根茎类</span>
                                            <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.GJLData}}</span> 亩/公斤</span>
                                        </div>
                                    </template>
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="白萝卜" class="formItem">
                                                <el-input v-model="ruleForm.veggieRadish" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入白萝卜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="生姜" class="formItem">
                                                <el-input v-model="ruleForm.veggieGinger" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入生姜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="胡萝卜" class="formItem">
                                                <el-input v-model="ruleForm.veggieCarrot" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入胡萝卜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="榨菜头" class="formItem">
                                                <el-input v-model="ruleForm.veggieMustard" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入榨菜头数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
                                ...
                                <el-collapse-item name="7-5">
                                    <template slot="title">
                                        <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7-5') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                            <span>瓜菜类</span>
                                            <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.GCLData}}</span> 亩/公斤</span>
                                        </div>
                                    </template>
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="黄瓜" class="formItem">
                                                <el-input v-model="ruleForm.veggieCuke" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入黄瓜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="冬瓜" class="formItem">
                                                <el-input v-model="ruleForm.veggieWinterMelon" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入冬瓜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="南瓜" class="formItem">
                                                <el-input v-model="ruleForm.veggiePumpkin" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入南瓜数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
                                ...
                                <el-collapse-item name="7-6">
                                    <template slot="title">
                                        <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7-6') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                            <span>豆类</span>
                                            <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.DLData}}</span> 亩/公斤</span>
                                        </div>
                                    </template>
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="豇豆" class="formItem">
                                                <el-input v-model="ruleForm.veggieCowpea" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入豇豆数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="四季豆" class="formItem">
                                                <el-input v-model="ruleForm.veggieKidneyBean" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入四季豆数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
                                ...
                                <el-collapse-item name="7-7">
                                    <template slot="title">
                                        <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7-7') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                            <span>茄果类</span>
                                            <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.QGLData}}</span> 亩/公斤</span>
                                        </div>
                                    </template>
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="茄子" class="formItem">
                                                <el-input v-model="ruleForm.veggieEggplant" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入茄子数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="辣椒" class="formItem">
                                                <el-input v-model="ruleForm.veggiePepper" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入辣椒数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="西红柿" class="formItem">
                                                <el-input v-model="ruleForm.veggieTomato" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入西红柿数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
                                ...
                                <el-collapse-item name="7-8">
                                    <template slot="title">
                                        <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7-8') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                            <span>葱蒜类</span>
                                            <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.CSLData}}</span> 亩/公斤</span>
                                        </div>
                                    </template>
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="大葱" class="formItem">
                                                <el-input v-model="ruleForm.veggieLeeks" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入大葱数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="蒜头" class="formItem">
                                                <el-input v-model="ruleForm.veggieGarlic" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入蒜头数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
                                ...
                                <el-collapse-item name="7-9">
                                    <template slot="title">
                                        <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7-9') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                            <span>水生菜</span>
                                            <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.veggieLotusRoot}}</span> 亩/公斤</span>
                                        </div>
                                    </template>
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="莲藕" class="formItem">
                                                <el-input v-model="ruleForm.veggieLotusRoot" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入莲藕数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
                                ...
                                <el-collapse-item name="7-10">
                                    <template slot="title">
                                        <div class="titleContent"><i class="collapseDownIcon el-icon-caret-bottom" :class="[nameFlag.indexOf('7-10') >=0?'el-icon-caret-bottom':'el-icon-caret-right']"></i>
                                            <span>食用菌</span>
                                            <span class="titleRight">合计：<span class="valueStyle">{{ruleForm.SYJData}}</span> 亩/公斤</span>
                                        </div>
                                    </template>
                                    <div class="formContent">
                                        <el-form :model="ruleForm" status-icon label-width="100px" class="demo-ruleForm">
                                            <el-form-item label="香菇" class="formItem">
                                                <el-input v-model="ruleForm.fungusShiitake" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入香菇数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="黑木耳" class="formItem">
                                                <el-input v-model="ruleForm.fungusBlack" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入黑木耳数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                            <el-form-item label="蘑菇" class="formItem">
                                                <el-input v-model="ruleForm.fungusMushroom" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入蘑菇数量"></el-input> （亩/公斤）
                                            </el-form-item>
                                        </el-form>
                                    </div>
                                </el-collapse-item>
                    ...
                    <el-collapse-item name="8">
                        <template slot="title">
                            <div  class="titleContent">
                                ...
                                <span>瓜果类</span>
                                <span class="titleRight">总计：<span class="valueStyle">{{ruleForm.GGLData}}</span> 亩/公斤</span>
                            </div> 
                        </template>
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="西瓜" class="formItem">
                                    <el-input v-model="ruleForm.melonWater" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入西瓜数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="草莓" class="formItem">
                                    <el-input v-model="ruleForm.melonBerry" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入草莓数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="香瓜" class="formItem">
                                    <el-input v-model="ruleForm.melonMusk" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入香瓜数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="其他" class="formItem">
                                    <el-input v-model="ruleForm.melonOther" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入其他数量"></el-input> （亩/公斤）
                                </el-form-item>
                        ...
                        <div class="formContent">
                            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                                ...
                                <el-form-item label="青饲料" class="formItem">
                                    <el-input v-model="ruleForm.otherGreenfeed" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入青饲料数量"></el-input> （亩/公斤）
                                </el-form-item>
                                ...
                                <el-form-item label="盆栽观赏植物" class="formItem">
                                    <el-input v-model="ruleForm.otherPlant" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入盆栽观赏植物数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="花椒" class="formItem">
                                    <el-input v-model="ruleForm.otherWildPepper" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入花椒数量"></el-input> （亩/公斤）
                                </el-form-item>
                                <el-form-item label="八角" class="formItem">
                                    <el-input v-model="ruleForm.otherAnise" onkeyup="this.value = this.value.replace(/[^\d.]/g,'');"  :disabled="urlType" placeholder="请输入八角数量"></el-input> （亩/公斤）
                                </el-form-item>
...
<script>
//统计局---畜产品产量 接口
import { economicsPlantUtilDetail,economicsPlantUtilUpdate, economicsPlantUtilInsert } from '@/utils/api/ruralEconomy/economicsPlantUtil' 
...
export default {
    ...
    methods:{
        ...
        async getDataDetail(){
            ...
            let res = await economicsPlantUtilDetail({id:this.id});
        ...
        async updateData(){
            ...
            let res = await economicsPlantUtilUpdate(updateObj);
             if(res.data.status== 0){
                this.$message({
                    message: '编辑成功',
                    type: 'success'
        ...
        async addData(){
            ...
            let res = await economicsPlantUtilInsert(addObj);
             if(res.data.status== 0){
                this.$message({
                    message: '新增成功',
                    type: 'success'
