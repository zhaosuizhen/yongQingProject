        ...
        initMap() {
            ...
            if (!this.map) {
                this.map = new ZNXDWEBGIS.Map(this.$refs.map, {
                    ...
                    center: [116.52391,39.31859],
                    extent:[116.52391,39.31859],
        ...
        addLayer(options) {
            ...
            let layer = new ZNXDWEBGIS.Layer.DataLayer({
                ...
                workspace: options.workspace||"yongqing",
                tileUrl: geoserverurl + "/wms?",
                format: "image/png",
                layerSRS: options.layerSRS||"EPSG:4326",
                layers: (options.workspace||"yongqing:") + options.layername,
                vectorUrl: geoserverurl + "/ows?",
                vectorLayerName: (options.workspace||"yongqing:") + options.layername,
            ...
            ZNXDWEBGIS.Util.POST(
                geoserverurl + "/ows", {
                    ...
                    obj: {
                        ...
                        request: "GetFeature",
                        srsName: "EPSG:4326",
                        typename: "yongqing:XJXZQ1310232018",
