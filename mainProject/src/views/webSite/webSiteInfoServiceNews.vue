            ...
            <div class="webSite-table-content">
              <div class="webSite-news-content">
                <ul class="webSite-news-list-ul news-ul">
                  <li v-for="(item,i) in policyList" :key="i"><!--:to="{path:'/workTaskEdit',query{id:work_task.id}}"-->
                    <router-link :to="{path:'/infoService/webSiteInfoServiceNewsDetail',query:{id:item.id,paneName:'policySecond'}}" tag="div">
